...
export const USER_ORDER_ALIMTALK_TEMPLATE_IDS = {
  /** 템플릿1 예약신청: 주문 접수 안내 */
  RESERVATION_REQUESTED: "KA01TP260705114950771HpQwgk1EPta",
  /** 템플릿2 입금대기: 계좌 입금 안내 */
  PAYMENT_PENDING: "KA01TP260705125109927N90vqLW545j",
  /** 템플릿3 예약확정 */
  CONFIRMED: "KA01TP260705125815673fESKaZIH0n4",
  /** 템플릿4 픽업대기: 픽업 안내 */
  PICKUP_PENDING: "KA01TP260705130656649d5Uely9TweL",
  /** 템플릿5 픽업완료: 후기 유도 */
  PICKUP_COMPLETED: "KA01TP260705130919680nAySn9ogqwy",
  /** 템플릿6 취소완료: 입금 마감 초과 자동 취소 */
  CANCEL_COMPLETED_PAYMENT_EXPIRED: "KA01TP260705131112990fDmqrlN931l",
  /** 템플릿7 취소완료: 판매자(스토어) 취소 */
  CANCEL_COMPLETED_BY_SELLER: "KA01TP260705131301023wnh1F7xut6z",
  /** 템플릿8 취소환불대기: 판매자 환불 진행 안내 */
  CANCEL_REFUND_PENDING_BY_SELLER: "KA01TP2607051315137481dqGZs7jfLH",
  /** 템플릿9 취소환불완료 */
  CANCEL_REFUND_COMPLETED: "KA01TP260705131658604JiPSqkbDfJK",
} as const;
