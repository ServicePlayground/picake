...
import { useStatisticsOrders } from "@/apps/web-admin/features/statistics/hooks/queries/useStatisticsQuery";
...
export const StatisticsOrdersPage: React.FC = () => {
  const { data: statistics, isLoading } = useStatisticsOrders();
        ...
        <>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <StatisticsSummaryCard
              ...
              title="총 주문 수"
              value={`${statistics.total.toLocaleString()}건`}
          ...
          <StatisticsStatusCountCard
            title="주문 상태별 현황"
            description={`전체 ${statistics.total.toLocaleString()}건`}
