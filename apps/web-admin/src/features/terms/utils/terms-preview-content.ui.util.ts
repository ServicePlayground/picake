...
/** 약관 HTML 미리보기 영역 스타일 (Quill 출력 기준) */
export function getTermsPreviewContentStyles(): string {
  ...
  return `
    ...
    .${c} h3 {
      font-size: 14px; font-weight: 600; color: #27272a;
      margin: 18px 0 8px;
    }
    .${c} p { margin-bottom: 8px; }
    .${c} ol {
      list-style-type: decimal; padding-left: 18px; margin-bottom: 8px;
    }
    .${c} ul {
      list-style-type: disc; padding-left: 18px; margin-bottom: 8px;
    }
    ...
    .${c} table {
      width: 100%; border-collapse: collapse; margin: 10px 0 16px; font-size: 13px;
    }
    .${c} th {
      background: #f4f4f5; border: 1px solid #d4d4d8;
      padding: 8px 10px; text-align: left; font-weight: 600; color: #3f3f46;
    }
    .${c} td {
      border: 1px solid #d4d4d8; padding: 8px 10px; vertical-align: top; color: #52525b;
    }
  `;
}
